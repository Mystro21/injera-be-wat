...
export type TurnSeconds = 10 | 15 | 20 | 30;
...
export interface MatchSettings { playerName: string; playerCount: 2 | 3 | 4; difficulty: Difficulty; room: GameRoom; turnSeconds: TurnSeconds; sound: boolean; hints: boolean; reduceMotion: boolean }
...
export interface GameState {
  ...
  room: GameRoom; turnSeconds: TurnSeconds; sound: boolean; hints: boolean; reduceMotion: boolean; winnerIds: string[]; moveNumber: number;
}
