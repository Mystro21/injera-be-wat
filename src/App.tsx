...
const DEFAULT_SETTINGS: MatchSettings = { playerName: 'Player', playerCount: 2, difficulty: 'medium', room: 'classic', turnSeconds: 20, sound: true, hints: true, reduceMotion: false };
